...
final class FinanceV1
{
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function accrualPostings(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('finance')->post('/accrual/postings', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function accrualTypes(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('finance')->post('/accrual/types', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function accrualByDay(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('finance')->post('/accrual/by-day', $payload);
    }
}
