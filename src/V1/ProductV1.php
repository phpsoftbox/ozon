...
final class ProductV1
{
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function infoStocksByWarehouseFbo(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('product')->post('/info/stocks-by-warehouse/fbo', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function visibilityInfo(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('product')->post('/visibility/info', $payload);
    }
}
