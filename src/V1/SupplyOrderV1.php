...
final class SupplyOrderV1
{
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function actSummaryGet(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('supply-order')->post('/act/summary/get', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function actProductGet(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('supply-order')->post('/act/product/get', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function actAccept(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('supply-order')->post('/act/accept', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function actAcceptStatus(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('supply-order')->post('/act/accept/status', $payload);
    }
}
