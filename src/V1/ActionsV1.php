...
final class ActionsV1
{
    ...
    {
        return $this->client->v1('actions')->post('/auto-add/products/list', $payload);
    }
    ...
    {
        return $this->client->v1('actions')->post('/auto-add/products/candidates', $payload);
    }
    ...
    {
        return $this->client->v1('actions')->post('/auto-add/products/delete', $payload);
    }
    ...
    {
        return $this->client->v1('actions')->post('/auto-add/products/update', $payload);
    }
}
