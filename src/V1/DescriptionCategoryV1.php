...
final class DescriptionCategoryV1
{
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function dependentAttributes(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('description-category')->post('/dependent-attributes', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function dependentAttributesValues(array $payload = []): OzonApiResponse
    {
        return $this->client->v1('description-category')->post('/dependent-attributes/values', $payload);
    }
}
