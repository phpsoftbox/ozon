...
final class ProductV2
{
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function picturesImport(array $payload = []): OzonApiResponse
    {
        return $this->client->v2('product')->post('/pictures/import', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function certificationOptions(array $payload = []): OzonApiResponse
    {
        return $this->client->v2('product')->post('/certification/options', $payload);
    }
     ...
     * @return OzonApiResponse<string, mixed>
     */
    public function certificationParams(array $payload = []): OzonApiResponse
    {
        return $this->client->v2('product')->post('/certification/params', $payload);
    }
}
