...
{
    /**
     * @param list<SupplierAvailableWarehousesResponseCapacity> $capacity
    ...
    {
        return new self(
            capacity: OzonDtoValue::objectList($payload['capacity'] ?? null, SupplierAvailableWarehousesResponseCapacity::class),
