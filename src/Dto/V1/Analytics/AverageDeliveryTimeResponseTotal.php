...
final readonly class AverageDeliveryTimeResponseTotal implements OzonDtoInterface
{
    /**
    ...
    public function __construct(
        ...
        public ?V1AverageDeliveryTimeResponseOrdersCount $ordersCount,
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            ordersCount: OzonDtoValue::object($payload['orders_count'] ?? null, V1AverageDeliveryTimeResponseOrdersCount::class),
