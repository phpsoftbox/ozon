...
final readonly class V1AverageDeliveryTimeResponseClustersData implements OzonDtoInterface
{
    /**
     * @param list<V1AverageDeliveryTimeResponseClustersDataAmnesty> $anotherDeliveryTime
    ...
    public function __construct(
        ...
        public ?V1AverageDeliveryTimeResponseDeliveryTimeStatus $deliveryTimeStatus,
    ...
    {
        return new self(
            anotherDeliveryTime: OzonDtoValue::objectList($payload['another_delivery_time'] ?? null, V1AverageDeliveryTimeResponseClustersDataAmnesty::class),
            ...
            deliveryTimeStatus: OzonDtoValue::object($payload['delivery_time_status'] ?? null, V1AverageDeliveryTimeResponseDeliveryTimeStatus::class),
