...
final readonly class V1FbpCheckActStateResponse implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            error: OzonDtoValue::scalarObject($payload['error'] ?? null, FbpCheckActStateResponseErrorReason::class),
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, V1FbpCheckActStateResponseStatus::class),
