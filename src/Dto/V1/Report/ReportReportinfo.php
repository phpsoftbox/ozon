...
final readonly class ReportReportinfo implements OzonDtoInterface
{
    /**
     * @param list<ReportCommonReportAdditionalDataItem> $additionalData
    ...
    {
        return new self(
            additionalData: OzonDtoValue::objectList($payload['additional_data'] ?? null, ReportCommonReportAdditionalDataItem::class),
            ...
            extra: OzonDtoValue::extra($payload, ['additional_data', 'code', 'created_at', 'error', 'expires_at', 'file', 'params', 'report_type', 'status']),
        );
    }
}
