...
final readonly class SellerInfoResponseRating implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, RatingStatusEnum::class),
            valueType: OzonDtoValue::scalarObject($payload['value_type'] ?? null, SellerInfoResponseRatingTypeEnum::class),
