...
final readonly class V1WarehouseFBSCreateReturnPointListResponse implements OzonDtoInterface
{
    /**
     * @param list<V1WarehouseFBSCreateReturnPointListResponseReturnPoint> $points
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            points: OzonDtoValue::objectList($payload['points'] ?? null, V1WarehouseFBSCreateReturnPointListResponseReturnPoint::class),
