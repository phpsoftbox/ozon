...
final readonly class ProductV1ProductVisibilitySetResponseItems implements OzonDtoInterface
{
    ...
    {
        return new self(
            selectPermission: OzonDtoValue::scalarObject($payload['select_permission'] ?? null, ProductV1ProductVisibilitySetResponseItemsSelectPermissionEnum::class),
            sellerItemPlacement: OzonDtoValue::scalarObject($payload['seller_item_placement'] ?? null, ProductV1ProductVisibilitySetResponseItemsSellerItemPlacementEnum::class),
            sellerItemPlacementList: OzonDtoValue::scalarObjectList($payload['seller_item_placement_list'] ?? null, ProductV1ProductVisibilitySetResponseItemsSellerItemPlacementListEnum::class),
            showcasesVisibility: OzonDtoValue::scalarObject($payload['showcases_visibility'] ?? null, ProductV1ProductVisibilitySetResponseItemsShowcasesVisibilityEnum::class),
            showcasesVisibilityList: OzonDtoValue::scalarObjectList($payload['showcases_visibility_list'] ?? null, ProductV1ProductVisibilitySetResponseItemsShowcasesVisibilityListEnum::class),
