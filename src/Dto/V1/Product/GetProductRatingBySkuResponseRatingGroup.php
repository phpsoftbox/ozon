...
{
    /**
     * @param list<GetProductRatingBySkuResponseRatingCondition> $conditions
     * @param list<GetProductRatingBySkuResponseRatingImproveAttribute> $improveAttributes
    ...
    {
        return new self(
            conditions: OzonDtoValue::objectList($payload['conditions'] ?? null, GetProductRatingBySkuResponseRatingCondition::class),
            improveAtLeast: OzonDtoValue::int($payload['improve_at_least'] ?? null),
            improveAttributes: OzonDtoValue::objectList($payload['improve_attributes'] ?? null, GetProductRatingBySkuResponseRatingImproveAttribute::class),
