...
final readonly class ProductV1ProductPricesDetailsResponsePricePriceIndexIndexData implements OzonDtoInterface
{
    /**
     * @param array<string, mixed> $extra
     */
    public function __construct(
        public ?MoneyMoney2 $minPrice,
    ...
    {
        return new self(
            minPrice: OzonDtoValue::object($payload['min_price'] ?? null, MoneyMoney2::class),
