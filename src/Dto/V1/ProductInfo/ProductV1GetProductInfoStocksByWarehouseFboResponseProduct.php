...
final readonly class ProductV1GetProductInfoStocksByWarehouseFboResponseProduct implements OzonDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            extra: OzonDtoValue::extra($payload, ['offer_id', 'present', 'product_id', 'reserved', 'sku', 'warehouse_id']),
        );
    }
}
