...
final readonly class ActionParameter implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            autoStopActionReason: OzonDtoValue::scalarObject($payload['auto_stop_action_reason'] ?? null, ParameterAutoStopActionReasonEnum::class),
            ...
            discountType: OzonDtoValue::scalarObject($payload['discount_type'] ?? null, ActionParameterDiscountTypeEnum::class),
            ...
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, SellerActionsListRequestStatusEnum::class),
            title: OzonDtoValue::string($payload['title'] ?? null),
            type: OzonDtoValue::scalarObject($payload['type'] ?? null, SellerActionsListRequestActionTypeEnum::class),
