...
final readonly class V1SellerActionsProductsCandidatesResponseProduct implements OzonDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            quantType: OzonDtoValue::scalarObject($payload['quant_type'] ?? null, V1SellerActionsProductsCandidatesResponseProductQuantTypeEnum::class),
