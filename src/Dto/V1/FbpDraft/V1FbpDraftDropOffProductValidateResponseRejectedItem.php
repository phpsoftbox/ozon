...
final readonly class V1FbpDraftDropOffProductValidateResponseRejectedItem implements OzonDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            rejectionReasons: OzonDtoValue::scalarObjectList($payload['rejection_reasons'] ?? null, V1BundleItemErrorEnum::class),
