...
final readonly class ReceiptsSellerListResponseReceipt implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            operationType: OzonDtoValue::scalarObject($payload['operation_type'] ?? null, ReceiptsSellerListResponseReceiptOperationTypeEnum::class),
            ...
            type: OzonDtoValue::scalarObject($payload['type'] ?? null, ReceiptsSellerListResponseReceiptTypeEnum::class),
