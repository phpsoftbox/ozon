...
final readonly class SupplyOrderDetailsResponseSupply implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            overdueReason: OzonDtoValue::scalarObject($payload['overdue_reason'] ?? null, SupplyOverdueReasonEnum::class),
            ...
            supplyState: OzonDtoValue::scalarObject($payload['supply_state'] ?? null, SupplyStateEnum::class),
