...
final readonly class V1SupplyOrderCancelStatusResponse implements OzonDtoInterface
{
    ...
    {
        return new self(
            errorReasons: OzonDtoValue::scalarObjectList($payload['error_reasons'] ?? null, SupplyOrderCancelStatusResponseCancelOrderError::class),
            result: OzonDtoValue::object($payload['result'] ?? null, SupplyOrderCancelStatusResponseResult::class),
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, V1SupplyOrderCancelStatusResponseStatus::class),
