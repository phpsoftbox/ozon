...
final readonly class V1SupplyOrderPassStatusResponse implements OzonDtoInterface
{
    ...
    {
        return new self(
            errors: OzonDtoValue::scalarObjectList($payload['errors'] ?? null, V1SetVehicleError::class),
            result: OzonDtoValue::scalarObject($payload['result'] ?? null, V1SupplyOrderPassStatusResponseStatus::class),
