...
final readonly class V1ItemResponse implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            sfboAttribute: OzonDtoValue::scalarObject($payload['sfbo_attribute'] ?? null, V1ItemSfboAttribute::class),
            shipmentType: OzonDtoValue::scalarObject($payload['shipment_type'] ?? null, V1BundleItemShipmentType::class),
