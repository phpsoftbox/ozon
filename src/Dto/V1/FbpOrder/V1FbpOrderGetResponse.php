...
final readonly class V1FbpOrderGetResponse implements OzonDtoInterface
{
    ...
    {
        return new self(
            attentionReasons: OzonDtoValue::scalarObjectList($payload['attention_reasons'] ?? null, V1OrderAttentionTypeEnum::class),
            ...
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, V1OrderStatusEnum::class),
