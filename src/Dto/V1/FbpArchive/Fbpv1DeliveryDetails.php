...
final readonly class Fbpv1DeliveryDetails implements OzonDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            supplyType: OzonDtoValue::scalarObject($payload['supply_type'] ?? null, DeliveryDetailsSupplyType::class),
