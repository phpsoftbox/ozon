...
final readonly class WarehouseListResponseWarehouse implements OzonDtoInterface
{
    ...
    public function __construct(
        ...
        public ?bool $isAbleToSetPrice,
        public ?bool $isPresorted,
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            isAbleToSetPrice: OzonDtoValue::bool($payload['is_able_to_set_price'] ?? null),
            isPresorted: OzonDtoValue::bool($payload['is_presorted'] ?? null),
            ...
            extra: OzonDtoValue::extra($payload, ['has_entrusted_acceptance', 'is_rfbs', 'name', 'warehouse_id', 'can_print_act_in_advance', 'first_mile_type', 'has_postings_limit', 'is_karantin', 'is_kgt', 'is_economy', 'is_able_to_set_price', 'is_presorted', 'is_timetable_editable', 'min_postings_limit', 'postings_limit', 'min_working_days', 'status', 'working_days']),
        );
    }
}
