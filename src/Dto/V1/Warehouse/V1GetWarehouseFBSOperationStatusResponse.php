...
final readonly class V1GetWarehouseFBSOperationStatusResponse implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, GetWarehouseFBSOperationStatusResponseStatusEnum::class),
            type: OzonDtoValue::scalarObject($payload['type'] ?? null, GetWarehouseFBSOperationStatusResponseTypeEnum::class),
