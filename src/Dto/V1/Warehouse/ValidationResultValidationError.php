...
final readonly class ValidationResultValidationError implements OzonDtoInterface
{
    ...
    {
        return new self(
            characteristic: OzonDtoValue::scalarObject($payload['characteristic'] ?? null, ValidationErrorCharacteristicEnum::class),
            ...
            type: OzonDtoValue::scalarObject($payload['type'] ?? null, ValidationResultValidationErrorTypeEnum::class),
