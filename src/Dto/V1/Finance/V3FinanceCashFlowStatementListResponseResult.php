...
{
    /**
     * @param list<FinanceCashFlowStatementListResponseCashFlow> $cashFlows
    ...
    {
        return new self(
            cashFlows: OzonDtoValue::objectList($payload['cash_flows'] ?? null, FinanceCashFlowStatementListResponseCashFlow::class),
