...
final readonly class ActionsV1ActionsAutoAddProductsCandidatesResponseProducts implements OzonDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            extra: OzonDtoValue::extra($payload, ['action_price_to_auto_add', 'base_price', 'currency', 'marketplace_seller_price', 'max_discount_price', 'min_action_quantity', 'min_seller_price', 'name', 'offer_id', 'price', 'product_id', 'quantity_to_auto_add', 'sku']),
        );
    }
}
