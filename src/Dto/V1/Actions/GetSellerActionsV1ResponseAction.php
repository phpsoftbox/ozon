...
{
    /**
     * @param list<string> $autoAddDates
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            autoAddDates: OzonDtoValue::array($payload['auto_add_dates'] ?? null),
            ...
            extra: OzonDtoValue::extra($payload, ['id', 'title', 'action_type', 'description', 'date_start', 'date_end', 'auto_add_dates', 'freeze_date', 'potential_products_count', 'participating_products_count', 'is_participating', 'is_voucher_action', 'banned_products_count', 'with_targeting', 'order_amount', 'discount_type', 'discount_value']),
        );
    }
}
