...
final readonly class V1Day implements OzonDtoInterface
{
    /**
     * @param list<V1DayTimeSlot> $timeslots
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            timeslots: OzonDtoValue::objectList($payload['timeslots'] ?? null, V1DayTimeSlot::class),
