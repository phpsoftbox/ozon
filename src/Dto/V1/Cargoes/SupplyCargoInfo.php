...
final readonly class SupplyCargoInfo implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            contentType: OzonDtoValue::scalarObject($payload['content_type'] ?? null, CargoInfoContentTypeEnum::class),
            placementZoneType: OzonDtoValue::scalarObject($payload['placement_zone_type'] ?? null, CargoInfoPlacementZoneTypeEnum::class),
            trackingInfo: OzonDtoValue::object($payload['tracking_info'] ?? null, CargoInfoTrackingInfo::class),
            type: OzonDtoValue::scalarObject($payload['type'] ?? null, SupplyCargoInfoTypeEnum::class),
