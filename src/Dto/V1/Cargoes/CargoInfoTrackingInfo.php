...
final readonly class CargoInfoTrackingInfo implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, CargoInfoTrackingInfoStatusEnum::class),
            type: OzonDtoValue::scalarObject($payload['type'] ?? null, CargoInfoTrackingInfoTypeEnum::class),
