...
final readonly class CommentListResponseComment implements OzonDtoInterface
{
    ...
    {
        return new self(
            deviationReason: OzonDtoValue::string($payload['deviation_reason'] ?? null),
            ...
            isPublished: OzonDtoValue::bool($payload['is_published'] ?? null),
            isRejected: OzonDtoValue::bool($payload['is_rejected'] ?? null),
            ...
            extra: OzonDtoValue::extra($payload, ['deviation_reason', 'dislikes_amount', 'id', 'is_official', 'is_owner', 'is_published', 'is_rejected', 'likes_amount', 'parent_comment_id', 'published_at', 'text']),
        );
    }
}
