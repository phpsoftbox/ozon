...
use PhpSoftBox\Ozon\Dto\V1\Actions\ActionsV1ActionsAutoAddProductsCandidatesResponse;
use PhpSoftBox\Ozon\Dto\V1\Actions\ActionsV1ActionsAutoAddProductsDeleteResponse;
use PhpSoftBox\Ozon\Dto\V1\Actions\ActionsV1ActionsAutoAddProductsListResponse;
use PhpSoftBox\Ozon\Dto\V1\Actions\ActionsV1ActionsAutoAddProductsUpdateResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Analytics\AnalyticsV1AnalyticsCategoryComparisonResponse;
use PhpSoftBox\Ozon\Dto\V1\Analytics\AnalyticsV1AnalyticsDecommissionedGoodsResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesLabelTransportByOrderCreateResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesLabelTransportByOrderStatusResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesLabelTransportCreateResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesLabelTransportStatusResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesSuppliesGetResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesTransportActivateResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesTransportActivateStatusResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesTransportBindResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesTransportBindStatusResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesTransportCreateResponse;
use PhpSoftBox\Ozon\Dto\V1\Cargoes\CargoesV1CargoesTransportCreateStatusResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Carriage\CarriageCourierContactSetResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerApproveResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerCancelResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerCreateResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerDocumentGetResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerFillResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerGetResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerLabelGetResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerListResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerPlaceIntoResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerRemoveFromResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerRemovePostingsResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerStatusGetResponse;
use PhpSoftBox\Ozon\Dto\V1\Carriage\Carriagev1CarriageContainerTaskInfoResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Carriage\V1CarriageCourierContactGetResponse;
...
use PhpSoftBox\Ozon\Dto\V1\DescriptionCategory\CategoryDescriptionV1DescriptionCategoryDependentAttributesResponse;
use PhpSoftBox\Ozon\Dto\V1\DescriptionCategory\CategoryDescriptionV1DescriptionCategoryDependentAttributesValuesResponse;
...
use PhpSoftBox\Ozon\Dto\V1\FbpOrder\FbpV1FbpOrderDirectTplDlvEditResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Finance\FinanceV1GetFinanceAccrualByDayResponse;
use PhpSoftBox\Ozon\Dto\V1\Finance\FinanceV1GetFinanceAccrualPostingsResponse;
use PhpSoftBox\Ozon\Dto\V1\Finance\FinanceV1GetFinanceAccrualTypesResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Posting\PostingV1GetFbpPostingResponse;
use PhpSoftBox\Ozon\Dto\V1\Posting\PostingV1PostingFbpListResponse;
...
use PhpSoftBox\Ozon\Dto\V1\PricingStrategy\V1Empty;
...
use PhpSoftBox\Ozon\Dto\V1\Product\ProductV1ProductVisibilityInfoResponse;
...
use PhpSoftBox\Ozon\Dto\V1\ProductInfo\ProductV1GetProductInfoStocksByWarehouseFboResponse;
...
use PhpSoftBox\Ozon\Dto\V1\Report\ReportV1CreateCompanyFinanceRealizationPostingReportResponse;
...
use PhpSoftBox\Ozon\Dto\V1\SupplyOrder\SupplyOrderV1SupplyOrderActAcceptResponse;
use PhpSoftBox\Ozon\Dto\V1\SupplyOrder\SupplyOrderV1SupplyOrderActAcceptStatusResponse;
use PhpSoftBox\Ozon\Dto\V1\SupplyOrder\SupplyOrderV1SupplyOrderActProductGetResponse;
use PhpSoftBox\Ozon\Dto\V1\SupplyOrder\SupplyOrderV1SupplyOrderActSummaryGetResponse;
...
use PhpSoftBox\Ozon\Dto\V2\Cargoes\CargoesV2CargoesDeleteResponse;
use PhpSoftBox\Ozon\Dto\V2\Cargoes\CargoesV2CargoesDeleteStatusResponse;
use PhpSoftBox\Ozon\Dto\V2\Cargoes\CargoesV2CargoesGetResponse;
...
use PhpSoftBox\Ozon\Dto\V2\Posting\PostingV2PostingDigitalListResponse;
...
use PhpSoftBox\Ozon\Dto\V2\Product\CertificationV2ProductCertificateOptionsResponse;
use PhpSoftBox\Ozon\Dto\V2\Product\CertificationV2ProductCertificateParamsResponse;
use PhpSoftBox\Ozon\Dto\V2\Product\V2ProductCertificationListResponse;
use PhpSoftBox\Ozon\Dto\V2\ProductCertificate\CertificationV2ProductCertificateCreateResponse;
...
use PhpSoftBox\Ozon\Dto\V2\ProductPictures\ProductV2ProductInfoPicturesV2Response;
...
use PhpSoftBox\Ozon\Dto\V2\Review\ReviewChangeStatusV2Response;
use PhpSoftBox\Ozon\Dto\V2\Review\ReviewCommentDeleteV2Response;
use PhpSoftBox\Ozon\Dto\V2\Review\ReviewV2ReviewCountV2Response;
use PhpSoftBox\Ozon\Dto\V2\Review\ReviewV2ReviewInfoV2Response;
use PhpSoftBox\Ozon\Dto\V2\Review\ReviewV2ReviewListV2Response;
use PhpSoftBox\Ozon\Dto\V2\SupplyOrder\SupplyOrderV2SupplyOrderTimeslotListResponse;
...
use PhpSoftBox\Ozon\Dto\V3\PostingFbo\PostingV3PostingFboListResponse;
...
use PhpSoftBox\Ozon\Dto\V4\PostingFbs\PostingV4PostingFbsUnfulfilledListResponse;
...
final class OzonResponseDtoMap
{
    ...
    private const MAP = [
        ...
        'POST /v1/actions/auto-add/products/candidates'                  => ActionsV1ActionsAutoAddProductsCandidatesResponse::class,
        'POST /v1/actions/auto-add/products/delete'                      => ActionsV1ActionsAutoAddProductsDeleteResponse::class,
        'POST /v1/actions/auto-add/products/list'                        => ActionsV1ActionsAutoAddProductsListResponse::class,
        'POST /v1/actions/auto-add/products/update'                      => ActionsV1ActionsAutoAddProductsUpdateResponse::class,
        ...
        'POST /v1/analytics/category/comparison'                         => AnalyticsV1AnalyticsCategoryComparisonResponse::class,
        'POST /v1/analytics/data'                                        => AnalyticsAnalyticsGetDataResponse::class,
        'POST /v1/analytics/decommissioned-goods'                        => AnalyticsV1AnalyticsDecommissionedGoodsResponse::class,
        ...
        'POST /v1/cargoes/label/transport-by-order/create'               => CargoesV1CargoesLabelTransportByOrderCreateResponse::class,
        'POST /v1/cargoes/label/transport-by-order/status'               => CargoesV1CargoesLabelTransportByOrderStatusResponse::class,
        'POST /v1/cargoes/label/transport/create'                        => CargoesV1CargoesLabelTransportCreateResponse::class,
        'POST /v1/cargoes/label/transport/status'                        => CargoesV1CargoesLabelTransportStatusResponse::class,
        'POST /v1/cargoes/rules/get'                                     => V1CargoesRulesGetResponse::class,
        'POST /v1/cargoes/supplies/get'                                  => CargoesV1CargoesSuppliesGetResponse::class,
        'POST /v1/cargoes/transport/activate'                            => CargoesV1CargoesTransportActivateResponse::class,
        'POST /v1/cargoes/transport/activate/status'                     => CargoesV1CargoesTransportActivateStatusResponse::class,
        'POST /v1/cargoes/transport/bind'                                => CargoesV1CargoesTransportBindResponse::class,
        'POST /v1/cargoes/transport/bind/status'                         => CargoesV1CargoesTransportBindStatusResponse::class,
        'POST /v1/cargoes/transport/create'                              => CargoesV1CargoesTransportCreateResponse::class,
        'POST /v1/cargoes/transport/create/status'                       => CargoesV1CargoesTransportCreateStatusResponse::class,
        ...
        'POST /v1/carriage/container/approve'                            => Carriagev1CarriageContainerApproveResponse::class,
        'POST /v1/carriage/container/cancel'                             => Carriagev1CarriageContainerCancelResponse::class,
        'POST /v1/carriage/container/create'                             => Carriagev1CarriageContainerCreateResponse::class,
        'POST /v1/carriage/container/document/get'                       => Carriagev1CarriageContainerDocumentGetResponse::class,
        'POST /v1/carriage/container/fill'                               => Carriagev1CarriageContainerFillResponse::class,
        'POST /v1/carriage/container/get'                                => Carriagev1CarriageContainerGetResponse::class,
        'POST /v1/carriage/container/label/get'                          => Carriagev1CarriageContainerLabelGetResponse::class,
        'POST /v1/carriage/container/list'                               => Carriagev1CarriageContainerListResponse::class,
        'POST /v1/carriage/container/place-into'                         => Carriagev1CarriageContainerPlaceIntoResponse::class,
        'POST /v1/carriage/container/remove-from'                        => Carriagev1CarriageContainerRemoveFromResponse::class,
        'POST /v1/carriage/container/remove-postings'                    => Carriagev1CarriageContainerRemovePostingsResponse::class,
        'POST /v1/carriage/container/status/get'                         => Carriagev1CarriageContainerStatusGetResponse::class,
        'POST /v1/carriage/container/task/info'                          => Carriagev1CarriageContainerTaskInfoResponse::class,
        'POST /v1/carriage/courier-contact/get'                          => V1CarriageCourierContactGetResponse::class,
        'POST /v1/carriage/courier-contact/set'                          => CarriageCourierContactSetResponse::class,
        ...
        'POST /v1/description-category/dependent-attributes'             => CategoryDescriptionV1DescriptionCategoryDependentAttributesResponse::class,
        'POST /v1/description-category/dependent-attributes/values'      => CategoryDescriptionV1DescriptionCategoryDependentAttributesValuesResponse::class,
        ...
        'POST /v1/fbp/order/direct/tpl-dlv/edit'                         => FbpV1FbpOrderDirectTplDlvEditResponse::class,
        ...
        'POST /v1/finance/accrual/by-day'                                => FinanceV1GetFinanceAccrualByDayResponse::class,
        'POST /v1/finance/accrual/postings'                              => FinanceV1GetFinanceAccrualPostingsResponse::class,
        'POST /v1/finance/accrual/types'                                 => FinanceV1GetFinanceAccrualTypesResponse::class,
        ...
        'POST /v1/posting/fbp/get'                                       => PostingV1GetFbpPostingResponse::class,
        'POST /v1/posting/fbp/list'                                      => PostingV1PostingFbpListResponse::class,
        ...
        'POST /v1/pricing-strategy/delete'                               => V1Empty::class,
        ...
        'POST /v1/product/info/stocks-by-warehouse/fbo'                  => ProductV1GetProductInfoStocksByWarehouseFboResponse::class,
        ...
        'POST /v1/product/visibility/info'                               => ProductV1ProductVisibilityInfoResponse::class,
        ...
        'POST /v1/report/realization/posting/create'                     => ReportV1CreateCompanyFinanceRealizationPostingReportResponse::class,
        ...
        'POST /v1/supply-order/act/accept'                               => SupplyOrderV1SupplyOrderActAcceptResponse::class,
        'POST /v1/supply-order/act/accept/status'                        => SupplyOrderV1SupplyOrderActAcceptStatusResponse::class,
        'POST /v1/supply-order/act/product/get'                          => SupplyOrderV1SupplyOrderActProductGetResponse::class,
        'POST /v1/supply-order/act/summary/get'                          => SupplyOrderV1SupplyOrderActSummaryGetResponse::class,
        ...
        'POST /v2/cargoes/delete'                                        => CargoesV2CargoesDeleteResponse::class,
        'POST /v2/cargoes/delete/status'                                 => CargoesV2CargoesDeleteStatusResponse::class,
        'POST /v2/cargoes/get'                                           => CargoesV2CargoesGetResponse::class,
        ...
        'POST /v2/posting/digital/list'                                  => PostingV2PostingDigitalListResponse::class,
        ...
        'POST /v2/product/certificate/create'                            => CertificationV2ProductCertificateCreateResponse::class,
        'POST /v2/product/certification/list'                            => V2ProductCertificationListResponse::class,
        'POST /v2/product/certification/options'                         => CertificationV2ProductCertificateOptionsResponse::class,
        'POST /v2/product/certification/params'                          => CertificationV2ProductCertificateParamsResponse::class,
        'POST /v2/product/info/stocks-by-warehouse/fbs'                  => V2GetProductInfoStocksByWarehouseFbsResponseV2::class,
        'POST /v2/product/pictures/import'                               => ProductV2ProductInfoPicturesV2Response::class,
        ...
        'POST /v2/review/change-status'                                  => ReviewChangeStatusV2Response::class,
        'POST /v2/review/comment/delete'                                 => ReviewCommentDeleteV2Response::class,
        'POST /v2/review/count'                                          => ReviewV2ReviewCountV2Response::class,
        'POST /v2/review/info'                                           => ReviewV2ReviewInfoV2Response::class,
        'POST /v2/review/list'                                           => ReviewV2ReviewListV2Response::class,
        'POST /v2/supply-order/timeslot/list'                            => SupplyOrderV2SupplyOrderTimeslotListResponse::class,
        ...
        'POST /v3/posting/fbo/list'                                      => PostingV3PostingFboListResponse::class,
        ...
        'POST /v4/posting/fbs/list'                                      => PostingV4PostingFbsListResponse::class,
        ...
        'POST /v4/posting/fbs/unfulfilled/list'                          => PostingV4PostingFbsUnfulfilledListResponse::class,
