...
final readonly class WarehouseListV2ResponseWarehouse implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            carriageLabelType: OzonDtoValue::scalarObject($payload['carriage_label_type'] ?? null, WarehouseCarriageLabelTypeEnum::class),
            ...
            workingDays: OzonDtoValue::scalarObjectList($payload['working_days'] ?? null, WarehouseWorkingDaysEnum::class),
