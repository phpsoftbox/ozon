...
final readonly class V2DraftSupplyCreateStatusResponse implements OzonDtoInterface
{
    ...
    {
        return new self(
            errorReasons: OzonDtoValue::scalarObjectList($payload['error_reasons'] ?? null, V2DraftSupplyCreateStatusResponseErrorReasonEnum::class),
            orderId: OzonDtoValue::int($payload['order_id'] ?? null),
            status: OzonDtoValue::scalarObject($payload['status'] ?? null, V2DraftSupplyCreateStatusResponseStatusEnum::class),
