...
final readonly class DraftCreateInfoResponseError implements OzonDtoInterface
{
    ...
    {
        return new self(
            errorMessage: OzonDtoValue::scalarObject($payload['error_message'] ?? null, ErrorErrorMessageEnum::class),
            errorReasons: OzonDtoValue::scalarObjectList($payload['error_reasons'] ?? null, DraftCreateInfoResponseErrorErrorReasonEnum::class),
