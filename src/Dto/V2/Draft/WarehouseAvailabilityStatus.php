...
final readonly class WarehouseAvailabilityStatus implements OzonDtoInterface
{
    ...
    {
        return new self(
            invalidReason: OzonDtoValue::scalarObject($payload['invalid_reason'] ?? null, AvailabilityStatusInvalidReasonEnum::class),
            state: OzonDtoValue::scalarObject($payload['state'] ?? null, AvailabilityStatusStateEnum::class),
