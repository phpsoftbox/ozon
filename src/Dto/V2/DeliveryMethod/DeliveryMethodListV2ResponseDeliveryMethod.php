...
final readonly class DeliveryMethodListV2ResponseDeliveryMethod implements OzonDtoInterface
{
    ...
    public function __construct(
        ...
        public ?WarehouseV2DeliveryMethodListV2ResponseDeliveryMethodTPLDropOffPoint $tplDropoffPoint,
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            tplDropoffPoint: OzonDtoValue::object($payload['tpl_dropoff_point'] ?? null, WarehouseV2DeliveryMethodListV2ResponseDeliveryMethodTPLDropOffPoint::class),
            ...
            extra: OzonDtoValue::extra($payload, ['created_at', 'cutoff', 'id', 'is_express', 'name', 'provider_id', 'sla_cut_in', 'status', 'template_id', 'tpl_dropoff_point', 'tpl_integration_type', 'updated_at', 'warehouse_id']),
        );
    }
}
