...
final readonly class V2FboPosting implements OzonDtoInterface
{
    ...
    public function __construct(
        ...
        public ?PostingV2FboSinglePostingExternalOrder $externalOrder,
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            externalOrder: OzonDtoValue::object($payload['external_order'] ?? null, PostingV2FboSinglePostingExternalOrder::class),
            ...
            extra: OzonDtoValue::extra($payload, ['additional_data', 'analytics_data', 'cancel_reason_id', 'created_at', 'external_order', 'fact_delivery_date', 'financial_data', 'in_process_at', 'legal_info', 'order_id', 'order_number', 'posting_number', 'products', 'status', 'substatus']),
        );
    }
}
