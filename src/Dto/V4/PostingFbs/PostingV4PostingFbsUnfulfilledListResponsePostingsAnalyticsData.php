...
final readonly class PostingV4PostingFbsUnfulfilledListResponsePostingsAnalyticsData implements OzonDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            extra: OzonDtoValue::extra($payload, ['city', 'client_delivery_date_begin', 'client_delivery_date_end', 'delivery_date_begin', 'delivery_date_end', 'delivery_type', 'is_legal', 'is_premium', 'payment_type_group_name', 'region', 'tpl_provider', 'tpl_provider_id', 'warehouse', 'warehouse_id']),
        );
    }
}
