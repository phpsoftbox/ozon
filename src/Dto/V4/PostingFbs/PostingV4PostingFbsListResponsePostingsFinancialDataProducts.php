...
final readonly class PostingV4PostingFbsListResponsePostingsFinancialDataProducts implements OzonDtoInterface
{
    /**
    ...
    public function __construct(
        ...
        public ?PostingV4PostingFbsListResponsePostingsFinancialDataProductsCommission $commission,
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            commission: OzonDtoValue::object($payload['commission'] ?? null, PostingV4PostingFbsListResponsePostingsFinancialDataProductsCommission::class),
