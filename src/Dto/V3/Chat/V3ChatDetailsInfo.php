...
final readonly class V3ChatDetailsInfo implements OzonDtoInterface
{
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            chatStatus: OzonDtoValue::scalarObject($payload['chat_status'] ?? null, ChatInfoChatStatusEnum::class),
            chatType: OzonDtoValue::scalarObject($payload['chat_type'] ?? null, ChatInfoChatTypeEnum::class),
